...
\leftheader{%
  {\LARGE\bfseries\sffamily Nikhil Teja Sonaboyina}

  \makefield{\faEnvelope[regular]}{\href{mailto:nikhiltej4811421@gmail.com}{\texttt{Email}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/nikhil-teja-yadav-5b3197224/}{\texttt{LinkedIn}}}
  \makefield{\faPhone[regular]}
  {\texttt{+91 6302896212}}
  \makefield{\faGithub}
  {\href{https://github.com/nikhiltej5}{\texttt{GitHub}}}

  %% Next line
  % \makefield{\}{\url{http://example.example.org/}}
