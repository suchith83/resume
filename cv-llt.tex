...
\leftheader{%
  {\LARGE\bfseries\sffamily Koduru Suchith}

  \makefield{\faEnvelope[regular]}{\href{mailto:suchithcodingacc@gmail.com}{\texttt{Email}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/suchith-koduru-34966022b/}{\texttt{LinkedIn}}}
  \makefield{\faPhone[regular]}
  {\texttt{+91 8465073250}}
  \makefield{\faGithub}
  {\href{https://github.com/suchith83}{\texttt{GitHub}}}
